...
export default function EventReminder({
  ...
  return (
    <Html lang="id">
      <Head />
      <Preview>{`Reminder untuk kegiatan ${event.name}`}</Preview>
      <Tailwind>
          ...
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            <Section className="mt-[32px]">
              ...
              <Text className="text-black text-[14px] leading-[24px]">
                Hai {user.name}, email ini adalah reminder untuk kegiatan{" "}
...
EventReminder.PreviewProps = {
  event: {
    ...
    scheduledStart: new Date("2024-12-14T02:00:00Z"),
    scheduledEnd: new Date("2024-12-15T10:00:00Z"),
